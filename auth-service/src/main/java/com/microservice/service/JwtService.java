...
public class JwtService {
    ...
    // ADD THIS METHOD: Generate token with username and customerId
    public String generateToken(String username, Long customerId) {
        logger.info("Generating JWT token for username: {}, customerId: {}", username, customerId);
    ...
    // ADD THIS METHOD: Validate token and return username
    ...
    // This method can stay but rename to avoid confusion
